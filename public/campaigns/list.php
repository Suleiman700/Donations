...
<head>
    ...
    <!-- TITLE -->
    <title><?php echo $app->get_word("campaigns"); ?></title>
            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <h1 class="page-title"><?php echo $app->get_word("campaigns"); ?></h1>
                        <div>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo $app->public_dir; ?>dashboard/index.php"><?php echo $app->get_word("dashboard"); ?></a></li>
                                <li class="breadcrumb-item active" aria-current="page"><?php echo $app->get_word("campaigns"); ?></li>
                            </ol>
                        </div>
                    </div>
                    <!-- PAGE-HEADER END -->
                    ...
                    <div class="row d-flex justify-content-end">
                        <div class="col-xl-3 col-lg-12">
                            <a class="btn btn-primary btn-block float-end my-2" href="./add.php"><i class="fa fa-plus-square me-2"></i><?php echo $app->get_word("new_campaign"); ?></a>
                        </div>
                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered text-nowrap border-bottom" id="myTable">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="border-bottom-0"><?php echo $app->get_word("target"); ?></th>
                                                    <th class="border-bottom-0"><?php echo $app->get_word("start"); ?></th>
                                                    <th class="border-bottom-0"><?php echo $app->get_word("end"); ?></th>
...
<script type="module" src="../../Scripts/Campaigns/Campaigns_List_Job.js"></script>

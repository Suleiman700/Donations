...
$donations->set_id($_GET["id"]);

// Check if exist
if (!$donations->check_exist()) kick();

// Check if id is owned by the user
$added_by = $donations->get_added_by();
if ($added_by !== $session_user_id) kick();

// Get campaign data
//$id = $_GET["id"];
$donator_name = $donations->get_data("name");
$donator_phone = $donations->get_data("phone");
//$target = $donations->get_data("target");
//$start_date = date('d-m-Y', strtotime($donations->get_data("start_date")));
//$end_date = date('d-m-Y', strtotime($donations->get_data("end_date")));
//$description = $donations->get_data("description");
?>
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="row d-flex justify-content-end">
                        <div class="col-xl-3 col-lg-12">
                            <a class="btn btn-primary btn-block float-end my-2" href="./list.php">
                                <i class="fa fa-list me-2"></i><?php echo $app->get_word("campaigns_list"); ?>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12 col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title"><?php echo $app->get_word("donator_details"); ?></h3>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="donator_name" value="<?php echo $donator_name; ?>" placeholder="<?php echo $app->get_word("donator_name"); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                <label for="target"><?php echo $app->get_word("phone"); ?></label>
                                                <div class="input-group">
                                                    <div class="input-group-text">
                                                        <i class="fa fa-phone tx-16 lh-0 op-6"></i>
                                                    </div>
                                                    <input type="text" class="form-control" id="donator_phone" value="<?php echo $donator_phone; ?>" placeholder="<?php echo $app->get_word("donator_phone"); ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                <label for="name"><?php echo $app->get_word("campaign"); ?> <code>*</code></label>

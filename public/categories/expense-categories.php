...
<head>
    ...
    <!-- TITLE -->
    <title><?php echo $app->get_word("expense_categories"); ?></title>
            ...
            <div class="side-app">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="page-header">
                        <h1 class="page-title"><?php echo $app->get_word("expense_categories"); ?></h1>
                        <div>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo $app->public_dir; ?>dashboard/index.php"><?php echo $app->get_word("dashboard"); ?></a></li>
                                <li class="breadcrumb-item active" aria-current="page"><?php echo $app->get_word("expense_categories"); ?></li>
                            </ol>
                        </div>
                    </div>
                    <!-- PAGE-HEADER END -->
...
<script type="module" src="../../Scripts/ExpenseCategories_SCRIPTS/job.js"></script>

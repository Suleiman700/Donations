...
export async function edit_user_category() {
    ...
    $edit_cat_btn.click(async (e) => {
        ...
        // Setup request
        const ajax = new Ajax()
        ajax.controller = "Categories_Controller/CC_Income/CCI_Get_Category_Info_For_Edit.php"
        ajax.body = bodyObj
...
export async function submit_edit_user_category() {
    ...
    // Setup request
    const ajax = new Ajax()
    ajax.controller = "Categories_Controller/CC_Income/CCI_Edit_User_Category.php"
    ajax.body = bodyObj
